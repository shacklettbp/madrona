...
- Unfortunately, the barycentrics approach above is not particularly fast or
  ...
  A relatively recent paper Montanari a better, top-down search solution, that
  is much more stable but also faster in some cases due to the top down approach
...
inline Vector3 getHullSupportPointGJK(
    HalfEdgeMesh &hull,
    Vector3 v)
{
